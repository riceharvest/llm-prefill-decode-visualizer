...
import { xBotProtection } from '../_waf.js';
...
export default function handler(req, res) {
  ...
  const spec = {
    ...
    'x-bot-protection': xBotProtection()
  };
