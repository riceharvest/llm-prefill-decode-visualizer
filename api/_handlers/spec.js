...
const BEST_LIST_ENVELOPE = {
  ...
  properties: {
    ...
    total: { type: 'integer', description: 'Total ranked groups matched before the ?limit= cut (#522)' },
    returned: { type: 'integer', description: 'Rows actually returned (min(limit, total))' },
    limit: { type: 'integer', description: 'Effective row cap after defaulting/clamping of ?limit=' },
    has_more: { type: 'boolean', description: 'True when more matched groups exist beyond the returned rows (#522)' },
