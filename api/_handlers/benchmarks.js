...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Param spelling accepts both snake_case and camelCase via readParam.
    ...
    const groupByNorm = groupByRaw != null && groupByRaw !== '' ? GROUP_BY_KEYS[String(groupByRaw).toLowerCase()] : null;
