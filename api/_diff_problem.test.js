...
test('#545: missing runA/runB -> 400 application/problem+json with stable code', async () => {
  ...
  // Guidance is preserved as extra members, not dropped. (#965: CUID-shaped
  // placeholders, matching the integration tree's missing-param hint.)
  assert.equal(body.example, '/api/diff?runA=cmsxu9zyi0ck7ms01v41wipnd&runB=cmrpa80mz05aolg011rjzkfvk');
});
