...
// Single source of truth for the MCP tool surface. Both the live
// `tools/list` response below AND the static /.well-known/mcp.json manifest
// (generated by scripts/generate-mcp-manifest.mjs, asserted equal by
// mcp-manifest.test.js) derive from these definitions, so the two surfaces
// cannot drift apart (#848).
export const TOOLS = [
  {
...
// serverInfo + instructions exactly as returned by the live `initialize`
// handler; the manifest's server block mirrors these.
...
export function toolToRequest(name, args = {}) {
