...
T = TypeVar("T", bound="GetBestConfigsResponse429")


@_attrs_define
class GetBestConfigsResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_best_configs_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        get_best_configs_response_429.additional_properties = d
        return get_best_configs_response_429
