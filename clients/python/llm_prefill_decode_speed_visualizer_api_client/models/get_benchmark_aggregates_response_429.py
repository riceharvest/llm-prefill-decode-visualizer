...
T = TypeVar("T", bound="GetBenchmarkAggregatesResponse429")


@_attrs_define
class GetBenchmarkAggregatesResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_benchmark_aggregates_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        get_benchmark_aggregates_response_429.additional_properties = d
        return get_benchmark_aggregates_response_429
