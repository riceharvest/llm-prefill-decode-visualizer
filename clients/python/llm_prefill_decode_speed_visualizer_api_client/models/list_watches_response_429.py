...
T = TypeVar("T", bound="ListWatchesResponse429")



@_attrs_define
class ListWatchesResponse429:
    """ 
        Attributes:
            error (str | Unset):
            limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_watches_response_429.additional_properties = d
        return list_watches_response_429
