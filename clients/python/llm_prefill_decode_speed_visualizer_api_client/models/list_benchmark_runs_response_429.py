...
T = TypeVar("T", bound="ListBenchmarkRunsResponse429")



@_attrs_define
class ListBenchmarkRunsResponse429:
    """ 
        Attributes:
            error (str | Unset):
            limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_benchmark_runs_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        list_benchmark_runs_response_429.additional_properties = d
        return list_benchmark_runs_response_429
