...
T = TypeVar("T", bound="GetApiWatchDispatchResponse429")


@_attrs_define
class GetApiWatchDispatchResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_watch_dispatch_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        get_api_watch_dispatch_response_429.additional_properties = d
        return get_api_watch_dispatch_response_429
