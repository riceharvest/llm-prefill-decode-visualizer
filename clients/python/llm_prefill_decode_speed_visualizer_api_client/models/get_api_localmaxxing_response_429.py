...
T = TypeVar("T", bound="GetApiLocalmaxxingResponse429")



@_attrs_define
class GetApiLocalmaxxingResponse429:
    """ 
        Attributes:
            error (str | Unset):
            limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_localmaxxing_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        get_api_localmaxxing_response_429.additional_properties = d
        return get_api_localmaxxing_response_429
