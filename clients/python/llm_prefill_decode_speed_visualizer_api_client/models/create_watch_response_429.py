...
T = TypeVar("T", bound="CreateWatchResponse429")


@_attrs_define
class CreateWatchResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_watch_response_429.additional_properties = d
        return create_watch_response_429
