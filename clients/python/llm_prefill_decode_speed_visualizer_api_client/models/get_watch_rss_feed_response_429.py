...
T = TypeVar("T", bound="GetWatchRssFeedResponse429")


@_attrs_define
class GetWatchRssFeedResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_watch_rss_feed_response_429 = cls(
            error=error,
            limit=limit,
            remaining=remaining,
            reset=reset,
        ...
        get_watch_rss_feed_response_429.additional_properties = d
        return get_watch_rss_feed_response_429
