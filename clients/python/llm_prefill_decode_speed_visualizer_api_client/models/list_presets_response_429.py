...
T = TypeVar("T", bound="ListPresetsResponse429")


@_attrs_define
class ListPresetsResponse429:
    """
    Attributes:
        error (str | Unset):
        limit (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_presets_response_429.additional_properties = d
        return list_presets_response_429
