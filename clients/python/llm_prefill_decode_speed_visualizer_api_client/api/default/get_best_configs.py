...
def _get_kwargs(
    *,
    by: GetBestConfigsBy | Unset = UNSET,
    ...
    hw_class: GetBestConfigsHwClass | Unset = UNSET,
    hardware: str | Unset = UNSET,
    context_band: GetBestConfigsContextBand | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        quant (str | Unset):
        hw_class (GetBestConfigsHwClass | Unset):
        hardware (str | Unset):
        context_band (GetBestConfigsContextBand | Unset):
